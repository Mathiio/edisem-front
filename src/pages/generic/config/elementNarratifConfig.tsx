      ...
      categories: [
        {
          ...
          subcategories: [
            ...
            { key: 'niveauxNarration', label: 'Niveaux de narration / récits enchâssés / métalepse / mise en abyme', property: 'GenStory:a comme scenario', allowMultipleInputs: false,},
            ...
            { key: 'temporalite', label: 'Temporalité / Régime temporel / Image-temps (Deleuze)', property: 'dcterms:temporalCoverage', allowMultipleInputs: false,},
