    ...
    <div
      ...
      <div className='flex flex-col gap-10 justify-between'>
        ...
        <div className='flex flex-col gap-2 w-full'>
          ...
          <div className='flex flex-col gap-1.5 w-full'>
            <p className='text-16 text-c6 font-medium overflow-hidden line-clamp-2 leading-[1.2]'>{finalTitle}</p>
          </div>
          ...
          <div className='flex items-center gap-5'>
            ...
            <div className='flex flex-col gap-0.5 w-full'>
              <p className={`text-14 font-extralight w-full line-clamp-1 ${hasAuthors ? 'text-c4' : 'text-c5'}`}>{renderAuthorNames()}</p>
              {finalSubtitle && <p className='text-12 text-c5 font-extralight w-full line-clamp-1'>{finalSubtitle}</p>}
            </div>
          </div>
        </div>
      </div>
      ...
      <div className='flex justify-between gap-10'>
        <div className='flex gap-1.5 items-center min-w-0'>
          ...
          <p className='text-14 text-c4/60 font-medium truncate'>{finalTypeLabel}</p>
        </div>
